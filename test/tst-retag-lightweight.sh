...
test_run() {
    ...
    test_make_commit "$test_repo"
    test_run_release_script "$test_repo" -l -r patch

    test_validate_tags "$test_repo" v1,v1.1,v1.1.0,v1.1.1,v1.1.2
    test_validate_tags "$test_repo" v1,v1.1.0,v1.1.1 annotated
    test_validate_tags "$test_repo" v1.1,v1.1.2 lightweight
